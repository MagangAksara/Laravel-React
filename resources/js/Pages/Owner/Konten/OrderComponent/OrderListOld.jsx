                                ...
                                <div
                                    className={`${
                                        ...
                                        (order.status !== "waiting_for_check" && order.status !== "on_rent")
                                            ...
                                            : order.status === "on_rent"
                                                ? "grid grid-cols-1 lg:grid-cols-3 gap-2 justify-end" // ada 2 tombol (Details + Finish)
                                                : "grid grid-cols-1 lg:grid-cols-3 gap-2 justify-end" // waiting_for_check (Complete + Extra Payment)
                                        }`}
                                >
            ...
            <FinishNowModal
                ...
                onConfirm={() => {
                    ...
                    router.patch(
                        ...
                        { overdue: selectedOverdue.overdueHours }, // ✅ hook tetap konsisten
                        {
                            preserveState: true,
                            onSuccess: () => toast.success("Status updated successfully"),
                            onError: () => toast.error("Gagal update status"),
